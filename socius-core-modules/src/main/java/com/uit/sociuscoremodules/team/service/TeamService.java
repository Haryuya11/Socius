...
public interface TeamService {
  ...
  /**
   * Get all teams with filters, sorting, and pagination.
   *
   * @param filter the filter criteria
   * @return map containing list of teams and pagination info
   */
  Map<String, Object> getAllTeams(TeamFilterRequest filter);

  /**
   * Search teams with pagination and sorting.
   *
   * @param request the search request with condition, pagination, and sorting
   * @return map containing list of teams, total count, and pagination info
   */
  Map<String, Object> searchTeams(PaginationSearchRequest<TeamSearchRequest> request);
