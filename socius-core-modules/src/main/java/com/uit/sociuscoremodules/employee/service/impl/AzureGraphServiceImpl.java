...
import com.uit.sociuscoremodules.employee.constants.GraphUserFields;
...
@Slf4j
public class AzureGraphServiceImpl extends BaseServiceImpl implements AzureGraphService {
  ...
  public User createUser(EmployeeCreateRequest request) {
    try {
      ...
      throw badRequest(MessageConstant.E_EMP_001);
    }
  }
  ...
  public void deactivateUser(String clientId) {
    try {
      ...
      log.error(e.getMessage(), e);
      throw badRequest(MessageConstant.E_EMP_003);
    }
  }
  ...
  public User findById(String clientId) {
    try {
      ...
      log.error(e.getMessage(), e);
      throw badRequest(MessageConstant.E_EMP_004);
    }
  }
