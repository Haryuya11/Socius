...
public final class MessageConstant {
  ...
  /** Access denied error message key. */
  public static final String E_SYS_002 = "E_SYS_002";

  /** Resource not found error message key. */
  public static final String E_SYS_003 = "E_SYS_003";
